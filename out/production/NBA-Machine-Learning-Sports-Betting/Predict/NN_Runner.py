...
ml_model_path = 'Models/NN_Models/Trained-Model-ML-1699315388.285516'

if os.path.isfile(ml_model_path):
    print(f">>>   File found at: {ml_model_path}")
else:
    print(f">>>   File not found at: {ml_model_path}")



if os.path.isdir(ml_model_path):
    print(f">>>   Directory found at: {ml_model_path}")
    print(">>>   Listing contents:")
    for item in os.listdir(ml_model_path):
        print(item)
else:
    print(f">>>   No directory found at: {ml_model_path}")
