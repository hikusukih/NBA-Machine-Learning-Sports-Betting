...
def xgb_runner(data, todays_games_uo, frame_ml, games, home_team_odds, away_team_odds, kelly_criterion,
    ...
    with mlflow.start_run(run_name=f"NBA predictions for {p_date}"):
        mlflow.log_param("home_team_odds", home_team_odds)
        mlflow.log_param("away_team_odds", away_team_odds)
        mlflow.log_param("kelly_criteron", kelly_criterion)
        ...
        mlflow.xgboost.logModel(xgb_ml, "xgboost_moneyline_model")
        mlflow.xgboost.logModel(xgb_uo, "xgboost_underover_model")
